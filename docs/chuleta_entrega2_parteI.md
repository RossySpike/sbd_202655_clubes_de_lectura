...
10. Elenco de obras
11. **Sección 20:** 2 reuniones realizadas (`realizada='S'`, 28/01/2026 y 30/01/2026) + 4 inasistencias (datos para las funciones)
...
> **Fechas de FK en las inasistencias:** `fecha_i` y `fec_i_g_lec` NO son '01/01/2026' sino las fechas reales de ingreso al grupo de cada lector (v-adu02 → 24/06/2024, v-adu03 → 22/12/2023, v-adu04 → 03/02/2025). Oracle valida estas columnas contra la PK de `MJV_g_lec`, por eso deben coincidir exactamente.
