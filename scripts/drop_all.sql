-- =============================================================================
-- SCRIPT DE ELIMINACIÓN TOTAL DE OBJETOS (VISTAS, TABLAS, SECUENCIAS, TRIGGERS, FUNCIONES, PROCEDIMIENTOS, ÍNDICES)
-- =============================================================================
...
BEGIN
   FOR vw IN (SELECT view_name FROM user_views WHERE view_name LIKE 'MJV\_%' ESCAPE '\') LOOP
...
-- 5. DROP TABLAS (con cascade constraints)
...
-- 7. DROP ÍNDICES (opcional, porque ya se eliminan con las tablas; pero por si acaso)
...
FROM user_objects
WHERE object_name LIKE 'MJV\_%' ESCAPE '\'
